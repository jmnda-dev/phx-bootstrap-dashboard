defmodule FmsWeb.ProductLiveTest do
  use FmsWeb.ConnCase

  import Phoenix.LiveViewTest
  import Fms.ProductsFixtures

  @create_attrs %{name: "some name", description: "some description", available: true, price: "120.5", stock_quantity: 42}
  @update_attrs %{name: "some updated name", description: "some updated description", available: false, price: "456.7", stock_quantity: 43}
  @invalid_attrs %{name: nil, description: nil, available: false, price: nil, stock_quantity: nil}

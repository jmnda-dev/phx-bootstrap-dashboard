defmodule FmsWeb.Components.LayoutComponents do
  use Phoenix.Component, global_prefixes: ~w(x- data-bs- aria-)
  use FmsWeb, :verified_routes

  attr :active_link, :atom, values: [:dashboard, :products, :product_categories]
  ...
  def sidebar(assigns) do
    ...
    >
      ...
      <div
        class="collapse navbar-collapse px-4 overflow-auto min-vh-100 w-auto "
        id="sidenav-collapse-main"
      >
        <ul class="navbar-nav">
          <li class="nav-item">
            <.link class={["nav-link", @active_link == :dashboard && "active"]} navigate={~p"/"}>
              <div class="text-center d-flex align-items-center justify-content-center">
                <i class="icon icon-shape icon-sm px-0  fa-solid fa-chart-pie"></i>
              </div>
          ...
          <li class="nav-item">
            <a
              ...
              href="#vehicles-menu"
              class={[
                "nav-link text-white opacity-9",
                (@active_link in [:products, :product_categories] && "active") || "collapsed"
              ]}
              aria-controls="vehicles-menu"
              role="button"
              aria-expanded={(@active_link in [:products, :product_categories] && "true") || "false"}
            >
              <div class="border-radius-md text-center d-flex align-items-center justify-content-center">
                <i class="icon icon-shape icon-sm px-0 fa-solid fa-truck"></i>
              </div>
              <span class="nav-link-text ms-1">Products</span>
            </a>
            <div
              class={["collapse", @active_link in [:products, :product_categories] && "show"]}
              id="vehicles-menu"
            >
              <ul class="nav border-start ms-4">
                <li class="nav-item ">
                  <.link
                    class={["nav-link text-white opacity-9", @active_link == :products && "active"]}
                    navigate={~p"/products"}
                  >
                ...
                <li class="nav-item ">
                  <.link
                    class={[
                      "nav-link text-white opacity-9",
                      @active_link == :product_categories && "active"
                    ]}
                    navigate={~p"/product_categories"}
                  >
                    <span class="sidenav-mini-icon"> O </span>
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
                ...
                <li class="mb-2">
                  <a class="dropdown-item border-radius-md" href="javascript:;">
                    <div class="d-flex py-1">
                      <div class="my-auto">
                        <img
                          src="/images/small-logos/logo-google.svg"
            ...
            <li class="nav-item ps-2 d-flex align-items-center">
              <a href="javascript:;" class="nav-link text-body p-0">
                <img src="/images/team-2.jpg" class="avatar avatar-sm" alt="avatar" />
              </a>
            </li>
          </ul>
        </div>
